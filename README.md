...
<img style="image-rendering: auto;	height: 25px; width: 25px;" src="https://api.berk404.ga/circle?image=https://api.prince527gaming.repl.co/avatar?user=418159397643091979" alt="credit-DiamondGolurk"></img> **DiamondGolurk** `Programming` `Game Design`

<img style="image-rendering: auto;	height: 25px; width: 25px;" src="https://api.berk404.ga/circle?image=https://api.prince527gaming.repl.co/avatar?user=488363709992009728" alt="credit-Txtur"></img> **txtur** `Textures` `Game Design`

<img style="image-rendering: auto;	height: 25px; width: 25px;" src="https://api.berk404.ga/circle?image=https://api.prince527gaming.repl.co/avatar?user=459802006123446273" alt="credit-tRoboticGamer"></img> **tRoboticGamer** `Sound Design` `Tilemap`
